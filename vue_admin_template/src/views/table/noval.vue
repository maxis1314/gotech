...
<el-tabs v-model="activeName"  @tab-click="handleClick" ref="table">
      ...
      <el-table-column align="center" label="ID" width="95" className="my-cell" sortable prop="id">
        <template slot-scope="scope">
           ...
           <el-link :underline="false" @click="download_id(scope.row.id)"></el-link>
               ...
               <el-table-column label="Sentence"   width="" className="my-cell" sortable prop="sentence">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.sentence)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Prinum"   width="95" className="my-cell" sortable prop="prinum">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.prinum)"></span>
         <!--
            <no-ssr>
               <mavon-editor
                v-model="scope.row.prinum"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
         ...
         -->
               ...
               <el-table-column label="Type"   width="95" className="my-cell" sortable prop="type">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.type)"></span>
         <!--
            <no-ssr>
               <mavon-editor
    ...
    >
      ...
      <el-table-column align="left" label="List" className="my-cell">
        <template slot-scope="scope">        
            ...
            <div><!-- <el-tag type="success" size="mini">Sentence</el-tag><br>-->
            <span v-html="showHighlight(scope.row.sentence)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.sentence"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Prinum</el-tag><br>-->
            <span v-html="showHighlight(scope.row.prinum)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.prinum"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Type</el-tag><br>-->
            <span v-html="showHighlight(scope.row.type)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.type"
    ...
    <p  style="text-align:center; line-height:10px;">{{ totalCount }}</p>
      ...
      <el-collapse-item v-for="(item,index) in list" :title="'['+item.id +']'"  name="1">
            ...
            <div><el-tag type="success" size="mini">Sentence</el-tag><br>
            <span v-html="showHighlight(item.sentence)"></span>
        <!--
         <no-ssr>
               <mavon-editor
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Prinum</el-tag><br>
            <span v-html="showHighlight(item.prinum)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.prinum"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Type</el-tag><br>
            <span v-html="showHighlight(item.type)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.type"
    ...
    />
     ...
     <el-tab-pane label="Graph" name="fourth">
      <div id='myChart_noval' style='width：600px;height:600px'></div>     
    </el-tab-pane>
     ...
     <el-tab-pane label="Form" name="fifth">
        ...
        <el-form :model="form"  label-width="100px">
            ...
            <el-form-item label="Sentence">
               <el-input v-model="form.sentence" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.sentence" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    
            </el-form-item>
            

            <el-form-item label="Prinum">
               <el-input v-model="form.prinum" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.prinum" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Type">
               <el-input v-model="form.type" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.type" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    ...
    <el-dialog title="Form" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      <el-form :model="form"  label-width="100px">
        ...
        -->
             ...
             <el-input-number v-model="form.prinum"></el-input-number>
             </el-form-item>
    ...
    $imgAdd(pos, $file){
     ...
     drawLine(){
        axios({
           ...
           console.log(url)
           let myChart = echarts.init(document.getElementById('myChart_noval'))
