...
<el-tabs v-model="activeName"  @tab-click="handleClick" ref="table">
      ...
      <el-table-column align="center" label="ID" width="95" className="my-cell" sortable prop="id">
        <template slot-scope="scope">
           ...
           <el-link :underline="false" @click="download_id(scope.row.id)"></el-link>
               ...
               <el-table-column label="SepalLength"   width="" className="my-cell" sortable prop="sepal_length">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.sepal_length)"></span>
         <!--
            <no-ssr>
               <mavon-editor
                v-model="scope.row.sepal_length"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
         ...
         -->
               ...
               <el-table-column label="SepalWidth"   width="" className="my-cell" sortable prop="sepal_width">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.sepal_width)"></span>
         <!--
            <no-ssr>
               <mavon-editor
                v-model="scope.row.sepal_width"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
         ...
         -->
               ...
               <el-table-column label="PetalLength"   width="" className="my-cell" sortable prop="petal_length">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.petal_length)"></span>
         <!--
            <no-ssr>
               <mavon-editor
                v-model="scope.row.petal_length"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
         ...
         -->
               ...
               <el-table-column label="PetalWidth"   width="" className="my-cell" sortable prop="petal_width">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.petal_width)"></span>
         <!--
            <no-ssr>
               <mavon-editor
                v-model="scope.row.petal_width"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
         ...
         -->
               ...
               <el-table-column label="Tag"   width="" className="my-cell" sortable prop="tag">
         ...
         -->
               ...
               <el-table-column label="Class"   width="" className="my-cell" sortable prop="class">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.class)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Flag"   width="" className="my-cell" sortable prop="flag">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.flag)"></span>
         <!--
            <no-ssr>
               <mavon-editor
    ...
    >
      ...
      <el-table-column align="left" label="List" className="my-cell">
        <template slot-scope="scope">        
            ...
            <div><!-- <el-tag type="success" size="mini">SepalLength</el-tag><br>-->
            <span v-html="showHighlight(scope.row.sepal_length)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.sepal_length"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">SepalWidth</el-tag><br>-->
            <span v-html="showHighlight(scope.row.sepal_width)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.sepal_width"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">PetalLength</el-tag><br>-->
            <span v-html="showHighlight(scope.row.petal_length)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.petal_length"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">PetalWidth</el-tag><br>-->
            <span v-html="showHighlight(scope.row.petal_width)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.petal_width"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Class</el-tag><br>-->
            <span v-html="showHighlight(scope.row.class)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.class"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Flag</el-tag><br>-->
            <span v-html="showHighlight(scope.row.flag)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.flag"
    ...
    <p  style="text-align:center; line-height:10px;">{{ totalCount }}</p>
      ...
      <el-collapse-item v-for="(item,index) in list" :title="'['+item.id +']'"  name="1">
            ...
            <div><el-tag type="success" size="mini">SepalLength</el-tag><br>
            <span v-html="showHighlight(item.sepal_length)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.sepal_length"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">SepalWidth</el-tag><br>
            <span v-html="showHighlight(item.sepal_width)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.sepal_width"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">PetalLength</el-tag><br>
            <span v-html="showHighlight(item.petal_length)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.petal_length"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">PetalWidth</el-tag><br>
            <span v-html="showHighlight(item.petal_width)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.petal_width"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Class</el-tag><br>
            <span v-html="showHighlight(item.class)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.class"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Flag</el-tag><br>
            <span v-html="showHighlight(item.flag)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.flag"
    ...
    />
     ...
     <el-tab-pane label="Graph" name="fourth">
      <div id='myChart_iris' style='width：600px;height:600px'></div>     
    </el-tab-pane>
     ...
     <el-tab-pane label="Form" name="fifth">
        ...
        <el-form :model="form"  label-width="100px">
            ...
            <el-form-item label="SepalLength">
               <el-input v-model="form.sepal_length" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.sepal_length" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    
            </el-form-item>
            

            <el-form-item label="SepalWidth">
               <el-input v-model="form.sepal_width" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.sepal_width" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    
            </el-form-item>
            

            <el-form-item label="PetalLength">
               <el-input v-model="form.petal_length" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.petal_length" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    
            </el-form-item>
            

            <el-form-item label="PetalWidth">
               <el-input v-model="form.petal_width" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.petal_width" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
        ...
        -->
            ...
            <el-form-item label="Class">
               <el-input v-model="form.class" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.class" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Flag">
               <el-input v-model="form.flag" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.flag" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    ...
    $imgAdd(pos, $file){
     ...
     drawLine(){
        axios({
           ...
           console.log(url)
           let myChart = echarts.init(document.getElementById('myChart_iris'))
