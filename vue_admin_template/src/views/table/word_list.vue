...
<el-tabs v-model="activeName"  @tab-click="handleClick" ref="table">
      ...
      <el-table-column align="center" label="ID" width="95" className="my-cell" sortable prop="id">
        <template slot-scope="scope">
           ...
           <el-link :underline="false" @click="download_id(scope.row.id)"></el-link>
               ...
               <el-table-column label="Key"   width="" className="my-cell" sortable prop="key">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.key)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Word"   width="" className="my-cell" sortable prop="word">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.word)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Word2"   width="" className="my-cell" sortable prop="word2">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.word2)"></span>
         <!--
            <no-ssr>
               <mavon-editor
                v-model="scope.row.word2"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
         ...
         -->
               ...
               <el-table-column label="Word3"   width="" className="my-cell" sortable prop="word3">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.word3)"></span>
         <!--
            <no-ssr>
               <mavon-editor
                v-model="scope.row.word3"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
      ...
      <el-table-column align="left" label="List" className="my-cell">
        <template slot-scope="scope">        
         ...
         <el-button type="success" plain size="medium" icon="el-icon-s-custom" @click="handleCustom(scope.$index,scope.row)">OPTION</el-button>
            ...
            <div><!-- <el-tag type="success" size="mini">Key</el-tag><br>-->
            <span v-html="showHighlight(scope.row.key)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.key"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Word</el-tag><br>-->
            <span v-html="showHighlight(scope.row.word)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.word"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Word2</el-tag><br>-->
            <span v-html="showHighlight(scope.row.word2)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.word2"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Word3</el-tag><br>-->
            <span v-html="showHighlight(scope.row.word3)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.word3"
       ...
       <!--  <el-button type="text" size="small" icon="el-icon-view" @click="show_drawer(scope.row)">详情</el-button>
        <el-button type="text" size="small" icon="el-icon-document-copy" @click="show_dialog(scope.row,1)">复制</el-button>
        <el-button type="text" size="small" icon="el-icon-edit" @click="show_dialog(scope.row)">编辑</el-button>
        <el-button type="text" size="small" icon="el-icon-connection" @click="goPath('/permission/info',{'key':scope.row.word})">RELATION</el-button>
    ...
    <p  style="text-align:center; line-height:10px;">{{ totalCount }}</p>
      ...
      <el-collapse-item v-for="(item,index) in list" :title="'['+item.id +']'"  name="1">
         ...
         <el-button type="success" plain size="medium" icon="el-icon-s-custom" @click="handleCustom(index,item)">OPTION</el-button>
            ...
            <div><el-tag type="success" size="mini">Key</el-tag><br>
            <span v-html="showHighlight(item.key)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.key"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Word</el-tag><br>
            <span v-html="showHighlight(item.word)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.word"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Word2</el-tag><br>
            <span v-html="showHighlight(item.word2)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.word2"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Word3</el-tag><br>
            <span v-html="showHighlight(item.word3)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.word3"
        ...
        <el-button type="text" size="small" icon="el-icon-connection" @click="goPath('/permission/info',{'key':item.word})">RELATION</el-button>
    ...
    />
     ...
     <el-tab-pane label="Graph" name="fourth">
      <div id='myChart_word_list' style='width：600px;height:600px'></div>     
    </el-tab-pane>
     ...
     <el-tab-pane label="Form" name="fifth">
        ...
        <el-form :model="form"  label-width="100px">
            ...
            <el-form-item label="Key">
               <el-input v-model="form.key" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.key" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Word">
               <el-input v-model="form.word" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.word" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    
            </el-form-item>
            

            <el-form-item label="Word2">
               <el-input v-model="form.word2" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.word2" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    
            </el-form-item>
            

            <el-form-item label="Word3">
               <el-input v-model="form.word3" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.word3" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    ...
    $imgAdd(pos, $file){
     ...
     drawLine(){
        axios({
           ...
           console.log(url)
           let myChart = echarts.init(document.getElementById('myChart_word_list'))
