...
<el-tabs v-model="activeName"  @tab-click="handleClick" ref="table">
      ...
      <el-table-column align="center" label="ID" width="95" className="my-cell" sortable prop="id">
        <template slot-scope="scope">
           ...
           <el-link :underline="false" @click="download_id(scope.row.id)"></el-link>
               ...
               <el-table-column label="Url"   width="" className="my-cell" sortable prop="url">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.url)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Encoding"   width="" className="my-cell" sortable prop="encoding">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.encoding)"></span>
         <!--
            <no-ssr>
               <mavon-editor
                v-model="scope.row.encoding"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
         ...
         -->
               ...
               <el-table-column label="Target"   width="" className="my-cell" sortable prop="target">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.target)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Attr"   width="" className="my-cell" sortable prop="attr">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.attr)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Regex"   width="" className="my-cell" sortable prop="regex">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.regex)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Result"   width="" className="my-cell" sortable prop="result">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.result)"></span>
         <!--
            <no-ssr>
               <mavon-editor
    ...
    >
      ...
      <el-table-column align="left" label="List" className="my-cell">
        <template slot-scope="scope">        
            ...
            <div><!-- <el-tag type="success" size="mini">Url</el-tag><br>-->
            <span v-html="showHighlight(scope.row.url)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.url"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Encoding</el-tag><br>-->
            <span v-html="showHighlight(scope.row.encoding)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.encoding"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Target</el-tag><br>-->
            <span v-html="showHighlight(scope.row.target)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.target"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Attr</el-tag><br>-->
            <span v-html="showHighlight(scope.row.attr)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.attr"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Regex</el-tag><br>-->
            <span v-html="showHighlight(scope.row.regex)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.regex"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Result</el-tag><br>-->
            <span v-html="showHighlight(scope.row.result)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.result"
    ...
    <p  style="text-align:center; line-height:10px;">{{ totalCount }}</p>
      ...
      <el-collapse-item v-for="(item,index) in list" :title="'['+item.id +']'"  name="1">
            ...
            <div><el-tag type="success" size="mini">Url</el-tag><br>
            <span v-html="showHighlight(item.url)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.url"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Encoding</el-tag><br>
            <span v-html="showHighlight(item.encoding)"></span>
        <!--
         <no-ssr>
               <mavon-editor
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Target</el-tag><br>
            <span v-html="showHighlight(item.target)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.target"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Attr</el-tag><br>
            <span v-html="showHighlight(item.attr)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.attr"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Regex</el-tag><br>
            <span v-html="showHighlight(item.regex)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.regex"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Result</el-tag><br>
            <span v-html="showHighlight(item.result)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.result"
    ...
    />
     ...
     <el-tab-pane label="Graph" name="fourth">
      <div id='myChart_crawler' style='width：600px;height:600px'></div>     
    </el-tab-pane>
     ...
     <el-tab-pane label="Form" name="fifth">
        ...
        <el-form :model="form"  label-width="100px">
            ...
            <el-form-item label="Url">
               <el-input v-model="form.url" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.url" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Encoding">
               <el-input v-model="form.encoding" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.encoding" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Target">
               <el-input v-model="form.target" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.target" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Attr">
               <el-input v-model="form.attr" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.attr" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Regex">
               <el-input v-model="form.regex" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.regex" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Result">
               <el-input v-model="form.result" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.result" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    ...
    $imgAdd(pos, $file){
     ...
     drawLine(){
        axios({
           ...
           console.log(url)
           let myChart = echarts.init(document.getElementById('myChart_crawler'))
