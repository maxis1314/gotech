...
<el-tabs v-model="activeName"  @tab-click="handleClick" ref="table">
      ...
      <el-table-column align="center" label="ID" width="95" className="my-cell" sortable prop="id">
        <template slot-scope="scope">
         ...
         -->
               ...
               <el-table-column label="Param"   width="" className="my-cell" sortable prop="param">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.param)"></span>
         <!--
            <no-ssr>
               <mavon-editor
    ...
    >
      ...
      <el-table-column align="left" label="List" className="my-cell">
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Param</el-tag><br>-->
            <span v-html="showHighlight(scope.row.param)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.param"
    ...
    <p  style="text-align:center; line-height:10px;">{{ totalCount }}</p>
      ...
      <el-collapse-item v-for="(item,index) in list" :title="'['+item.id +']'"  name="1">
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Param</el-tag><br>
            <span v-html="showHighlight(item.param)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.param"
    ...
    />
     ...
     <el-tab-pane label="Graph" name="fourth">
      <div id='myChart_script' style='width：600px;height:600px'></div>     
    </el-tab-pane>
     ...
     <el-tab-pane label="Form" name="fifth">
        ...
        -->
            ...
            <el-form-item label="Param">
               <el-input v-model="form.param" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.param" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    ...
    $imgAdd(pos, $file){
     ...
     drawLine(){
        axios({
           ...
           console.log(url)
           let myChart = echarts.init(document.getElementById('myChart_script'))
