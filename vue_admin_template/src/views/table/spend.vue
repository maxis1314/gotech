...
<el-tabs v-model="activeName"  @tab-click="handleClick" ref="table">
      ...
      <el-table-column align="center" label="ID" width="95" className="my-cell" sortable prop="id">
        <template slot-scope="scope">
         ...
         -->
               ...
               <el-table-column label="Amount"   width="" className="my-cell" sortable prop="amount">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.amount)"></span>
         <!--
            <no-ssr>
               <mavon-editor
    ...
    >
      ...
      <el-table-column align="left" label="List" className="my-cell">
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Amount</el-tag><br>-->
            <span v-html="showHighlight(scope.row.amount)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.amount"
    ...
    <p  style="text-align:center; line-height:10px;">{{ totalCount }}</p>
      ...
      <el-collapse-item v-for="(item,index) in list" :title="'['+item.id +']'"  name="1">
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Amount</el-tag><br>
            <span v-html="showHighlight(item.amount)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.amount"
    ...
    />
     ...
     <el-tab-pane label="Graph" name="fourth">
      <div id='myChart_spend' style='width：600px;height:600px'></div>     
    </el-tab-pane>
     ...
     <el-tab-pane label="Form" name="fifth">
        ...
        -->
            ...
            <el-form-item label="Amount">
               <el-input v-model="form.amount" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.amount" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
...
<el-form-item label="Amount">
          <el-input-number v-model="form.amount" :step="100"></el-input-number>
        </el-form-item>
    ...
    $imgAdd(pos, $file){
     ...
     drawLine(){
        axios({
           ...
           console.log(url)
           let myChart = echarts.init(document.getElementById('myChart_spend'))
