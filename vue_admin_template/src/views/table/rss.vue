...
<el-tabs v-model="activeName"  @tab-click="handleClick" ref="table">
      ...
      <el-table-column align="center" label="ID" width="95" className="my-cell" sortable prop="id">
        <template slot-scope="scope">
           ...
           <el-link :underline="false" @click="download_id(scope.row.id)"></el-link>
               ...
               <el-table-column label="Name"   width="" className="my-cell" sortable prop="name">
         ...
         -->
               ...
               <el-table-column label="Numall"   width="" className="my-cell" sortable prop="numall">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.numall)"></span>
         <!--
            <no-ssr>
               <mavon-editor
                v-model="scope.row.numall"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
         ...
         -->
               ...
               <el-table-column label="Numcur"   width="" className="my-cell" sortable prop="numcur">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.numcur)"></span>
         <!--
            <no-ssr>
               <mavon-editor
                v-model="scope.row.numcur"
                :subfield="false"
                :boxShadow="false"
                defaultOpen="preview"
                :toolbarsFlag="false"
         ...
         -->
               ...
               <el-table-column label="Weight"   width="" className="my-cell" sortable prop="weight">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.weight)"></span>
         <!--
            <no-ssr>
               <mavon-editor
    ...
    >
      ...
      <el-table-column align="left" label="List" className="my-cell">
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Numall</el-tag><br>-->
            <span v-html="showHighlight(scope.row.numall)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.numall"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Numcur</el-tag><br>-->
            <span v-html="showHighlight(scope.row.numcur)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.numcur"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Weight</el-tag><br>-->
            <span v-html="showHighlight(scope.row.weight)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.weight"
    ...
    <p  style="text-align:center; line-height:10px;">{{ totalCount }}</p>
      ...
      <el-collapse-item v-for="(item,index) in list" :title="'['+item.id +']'"  name="1">
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Numall</el-tag><br>
            <span v-html="showHighlight(item.numall)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.numall"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Numcur</el-tag><br>
            <span v-html="showHighlight(item.numcur)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.numcur"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Weight</el-tag><br>
            <span v-html="showHighlight(item.weight)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.weight"
    ...
    />
     ...
     <el-tab-pane label="Graph" name="fourth">
      <div id='myChart_rss' style='width：600px;height:600px'></div>     
    </el-tab-pane>
     ...
     <el-tab-pane label="Form" name="fifth">
        ...
        -->
            ...
            <el-form-item label="Numall">
               <el-input v-model="form.numall" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.numall" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    
            </el-form-item>
            

            <el-form-item label="Numcur">
               <el-input v-model="form.numcur" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.numcur" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Weight">
               <el-input v-model="form.weight" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.weight" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
    ...
    $imgAdd(pos, $file){
     ...
     drawLine(){
        axios({
           ...
           console.log(url)
           let myChart = echarts.init(document.getElementById('myChart_rss'))
