...
<el-tabs v-model="activeName"  @tab-click="handleClick" ref="table">
    ...
    />
     ...
     <el-tab-pane label="Graph" name="fourth">
      <div id='myChart_lifetarget' style='width：600px;height:600px'></div>     
    </el-tab-pane>
    ...
    $imgAdd(pos, $file){
     ...
     drawLine(){
        axios({
           ...
           console.log(url)
           let myChart = echarts.init(document.getElementById('myChart_lifetarget'))
