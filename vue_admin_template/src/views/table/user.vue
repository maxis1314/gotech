...
<el-tabs v-model="activeName"  @tab-click="handleClick" ref="table">
      ...
      <el-table-column align="center" label="ID" width="95" className="my-cell" sortable prop="id">
        <template slot-scope="scope">
           ...
           <el-link :underline="false" @click="download_id(scope.row.id)"></el-link>
               ...
               <el-table-column label="Name"   width="95" className="my-cell" sortable prop="name">
         ...
         -->
               ...
               <el-table-column label="Password"   width="95" className="my-cell" sortable prop="password">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.password)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Avatar"   width="95" className="my-cell" sortable prop="avatar">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.avatar)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Token"   width="95" className="my-cell" sortable prop="token">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.token)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Roles"   width="" className="my-cell" sortable prop="roles">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.roles)"></span>
         <!--
            <no-ssr>
               <mavon-editor
         ...
         -->
               ...
               <el-table-column label="Introduction"   width="95" className="my-cell" sortable prop="introduction">
               <template slot-scope="scope"><span v-html="showHighlight(scope.row.introduction)"></span>
         <!--
            <no-ssr>
               <mavon-editor
    ...
    >
      ...
      <el-table-column align="left" label="List" className="my-cell">
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Password</el-tag><br>-->
            <span v-html="showHighlight(scope.row.password)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.password"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Avatar</el-tag><br>-->
            <span v-html="showHighlight(scope.row.avatar)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.avatar"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Token</el-tag><br>-->
            <span v-html="showHighlight(scope.row.token)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.token"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Roles</el-tag><br>-->
            <span v-html="showHighlight(scope.row.roles)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.roles"
        ...
        -->
            ...
            <div><!-- <el-tag type="success" size="mini">Introduction</el-tag><br>-->
            <span v-html="showHighlight(scope.row.introduction)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="scope.row.introduction"
    ...
    <p  style="text-align:center; line-height:10px;">{{ totalCount }}</p>
      ...
      <el-collapse-item v-for="(item,index) in list" :title="'['+item.id +']'"  name="1">
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Password</el-tag><br>
            <span v-html="showHighlight(item.password)"></span>
        <!--
         <no-ssr>
               <mavon-editor
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Avatar</el-tag><br>
            <span v-html="showHighlight(item.avatar)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.avatar"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Token</el-tag><br>
            <span v-html="showHighlight(item.token)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.token"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Roles</el-tag><br>
            <span v-html="showHighlight(item.roles)"></span>
        <!--
         <no-ssr>
               <mavon-editor
                v-model="item.roles"
        ...
        -->
            ...
            <div><el-tag type="success" size="mini">Introduction</el-tag><br>
            <span v-html="showHighlight(item.introduction)"></span>
        <!--
         <no-ssr>
               <mavon-editor
    ...
    />
     ...
     <el-tab-pane label="Graph" name="fourth">
      <div id='myChart_user' style='width：600px;height:600px'></div>     
    </el-tab-pane>
     ...
     <el-tab-pane label="Form" name="fifth">
        ...
        -->
            ...
            <el-form-item label="Password">
               <el-input v-model="form.password" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.password" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Avatar">
               <el-input v-model="form.avatar" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.avatar" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Token">
               <el-input v-model="form.token" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.token" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Roles">
               <el-input v-model="form.roles" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.roles" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
            ...
            <el-form-item label="Introduction">
               <el-input v-model="form.introduction" autocomplete="off" type="" :autosize="{ minRows: 2, maxRows: 3}" @keyup.enter.native="do_submit" />
        <!--
        <div><mavon-editor  ref=md  v-model="form.introduction" @imgAdd="$imgAdd"  @save="saveDoc" /></div>
        -->
...
<el-form-item label="Encoding"><el-transfer v-model="form.roles" :data="data1" filterable :titles="['All', 'Assigned']"></el-transfer></el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      data1:[{key: 'admin',label:'admin'},
{key: 'editor',label:'editor'},
{key: 'sql_buffer',label:'sql_buffer'},
{key: 'user',label:'user'},
{key: 'pics',label:'pics'},
{key: 'task',label:'task'},
{key: 'pics2',label:'pics2'},
{key: 'tag',label:'tag'},
{key: 'iris',label:'iris'},
{key: 'intel',label:'intel'},
{key: 'blog',label:'blog'},
{key: 'blog2',label:'blog2'},
{key: 'blog3',label:'blog3'},
{key: 'memo',label:'memo'},
{key: 'memo2',label:'memo2'},
{key: 'memo3',label:'memo3'},
{key: 'lifetarget',label:'lifetarget'},
{key: 'successdiary',label:'successdiary'},
{key: 'log',label:'log'},
...
{key: 'rss_summary',label:'rss_summary'},
{key: 'word_list',label:'word_list'},
{key: 'noval',label:'en_list'}
    ...
    $imgAdd(pos, $file){
     ...
     drawLine(){
        axios({
           ...
           console.log(url)
           let myChart = echarts.init(document.getElementById('myChart_user'))
